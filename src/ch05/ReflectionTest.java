...
public class ReflectionTest {
    ...
    /**
     * Prints all permitted subtypes of a class
     *
     * @param cl a class
     */
    public static void printPermittedSubclasses(Class cl) {
        if (cl.isSealed()) {
            Class<?>[] permittedSubclassesClasses = cl.getPermittedSubclasses();
            for (int i = 0; i < permittedSubclassesClasses.length; i++) {
                if(i == 0)
                    System.out.print(" permits ");
                else
                    System.out.print(", ");
                System.out.print(permittedSubclassesClasses[i].getName());
            }
        }
    }
